...
$(function(){
    ...
    $('.faq__head').on('click', function() {
        ...
        if ($(this).siblings('.faq__body').is(':visible')) {
            $(this).siblings('.faq__body').slideUp();
            $(this).children().children('.checkmark').removeClass('active');
        } else {
            $('.faq__body').slideUp();
            $('.checkmark').removeClass('active');
            $(this).children().children('.checkmark').toggleClass('active');
    ...
    //         $(this).siblings('.faq__body').removeClass('active');
    //         $(this).removeClass('active');
    //     } else {
    //         $('.faq__body').slideUp();
    //         $(this).addClass('active');
    //         $(this).siblings('.faq__body').addClass('active');
    //     }
    // });
